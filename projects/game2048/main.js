			...
			if(board[i][j]!==0){
				for (var k = 0; k < i; k++) {
					if(board[k][j]===0&& noBlockVertical(j,k,i,board)){
						...
						board[i][j]=0;
						continue;
					}else if (board[k][j]===board[i][j] && noBlockVertical(j,k,i,board)&&!hasConflited[k][j]) {
						//move
						showMoveAnimation(i,j,k,j);
                        //add
                        board[k][j]+=board[i][j];
			...
			if(board[i][j]!==0){
				for (var k = 3; k >i; k--) {
					if(board[k][j]===0&& noBlockVertical(j,i,k,board)){
						...
						continue;
					}else if (board[k][j]===board[i][j] && noBlockVertical(j,i,k,board)&&!hasConflited[k][j]) {
						//move
						showMoveAnimation(i,j,k,j);
                        //add
                        board[k][j]+=board[i][j];
